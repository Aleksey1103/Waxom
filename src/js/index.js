$(document).ready(function () {
   ...
   $('.block-projects-nav__link').click(function(event){
       ...
       if (elementGroup == '.all') {
           $('.block-projects-grid-item').removeAttr('style').hide();
           ...
           var elementsArray = $(elementGroup);
           var i;
           for (i=0; i<3; i++) {
               $(elementsArray[i]).attr('style', '-ms-grid-column:' + ((i*2)+1) + ';' + '-ms-grid-row: 1');
           }
           for (i=3; i<elementsArray.length; i++) {
               $(elementsArray[i]).attr('style', '-ms-grid-column:' + ((i*2)-5) + ';' + '-ms-grid-row: 2');
           }
           $(elementGroup).fadeIn();
           $('.page__btn_more').hide();
       }                            
   ...
   $('.block-projects-grid-item').hover(            
       function () {
           ...
           $(this).find('.block-projects-grid__img').css({'background-color': 'black', 'opacity': '.5'});
